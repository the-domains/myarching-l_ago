...
dateModified: '2018-05-07T00:01:20.790Z'
datePublished: '2018-05-07T00:01:23.287Z'
...
Alla gestione degli immobili si abbinerà inoltre il recupero anche della zona agricola del circondario. Sarà redatto un piano agrario per realizzare i seguenti obiettivi di sostenibilità ambientale e agricola:

* creazione degli orti biologici
* creazione di un parco avventura 
* ripristino e manutenzione dei percorsi pedonali escursionistici della zona
* animali da fattoria
* creazione di un parco sensoriale
* centro di ippoterapia

## FASI DI ATTUAZIONE DEL METAPROGETTO

La prima fase del progetto , ormai avviata ci ha permesso di raggiungere un nucleo di edifici sufficiente a creare il cuore sostenibile dell'albergo diffuso. E grazie all'impegno profuso da tutti gli abitanti di L'Ago gli immobili che entrano a far parte del progetto continuano aad aumentare. ATP MyArching ha siglato con i proprietari degli immobili e dei terreni un contratto di progettazione che prevede:
...
* La compartecipazione di tutti i proprietari al finanziamento dell'impresa per la rivalutazione ambientale agricolo pastorale del circondario del borgo. 

Dopo la fase di rilievo degli immobili che si è attivata a metà febbraio 2018 sta per iniziare la fase progettuale (fase due) per la redazione dei progetti di risanamento degli immobili e stiamo predisponendo la documentazione necessaria per la gestione dell'albergo diffuso. Il progetto prevede la redazione del business plan per l'avvio dell'operazione immobiliare nel suo complesso. 

Nella fase di realizzazione degli interventi (fase tre) RTP MyArching si occuperà della direzione dei lavori, dei collaudi fino alla consegna degli immobili chiavi in mano ai proprietari; 

Nella fase di avvio dell'albergo diffuso (fase quattro), RTP MyArching si occuperà dell'organizzazione della parte promozionale e operativa per accompagnare la cooperativa di operatori del borgo alla autonoma gestione dei servizi e dell'albergo diffuso. In questo senso siamo già attivi per organizzare la fase promozionale del progetto di accoglienza utilizzando già alcuni immobili che possono accogliere alcuni ospiti creando quindi stimoli per l'iniziativa nel suo complesso.